...
\usepackage{titling}
\title{2019 Taiwan Online Programming Contest}
...
{
	\fancyhf{}
	\fancyhead[C]{\includegraphics[width=1\textwidth]{image/header.png}\\2019 ICPC Taiwan Online Programming Contest}
...
\problem{G}{rareone}{10}{1024}
\problem{H}{Table Tennis}{4}{1024}
\end{document}
